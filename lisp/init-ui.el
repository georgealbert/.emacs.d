...
(when IS-MAC
  ...
  (set-face-attribute 'default nil :font "IosevkaTermSS05 Nerd Font Mono + LXGW WenKai Mono Lite 16")
  ;; (set-face-attribute 'default nil :font "IosevkaTermSS05 Nerd Font Mono + LXGW WenKai Mono Lite 16"
  ;;                     :font-features '((TXTR . 1)))

  ;; (set-face-attribute 'default nil :font "InconsolataNFM + LXGW WenKai Mono Lite 16")
