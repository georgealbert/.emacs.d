...
(let ((class '((class color) (min-colors 89))))
  (custom-theme-set-faces
   ...
   ;; `(mode-line-buffer-id ((,class (:weight normal :background nil :foreground "SeaGreen2"))))
   `(mode-line-buffer-id ((,class (:weight normal :background nil :foreground "CadetBlue1"))))

   ;; `(mode-line-inactive ((,class (:background "gray40" :foreground "black" :box (:line-width 1 :color "gray40" :style nil)))))
   ;; `(mode-line-inactive ((,class (:background "gray40" :foreground "black" :box (:line-width 1 :color "gray40" :style nil)))))
   `(mode-line-inactive ((,class (:background "gray40" :foreground "black" :box (:line-width 1 :color "gray40" :style released-button)))))
   ;; `(mode-line-inactive ((,class (:background "gray40" :foreground "black"))))
   ;; linenumber from doom-theme

   `(line-number ((,class (:foreground "gray50"))))
   `(line-number-current-line ((,class (:foreground "gray80"))))
   ...
   ;; `(org-table ((,class (:foreground "#EE82EE"))))
